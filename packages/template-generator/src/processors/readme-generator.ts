...
This project was created with [KPS](https://github.com/kyphans/create-kps), a modern TypeScript stack${
...
function generateDeploymentCommands(
  ...
  lines.push(
    "",
    "For more details, see the guide on [Deploying to Cloudflare with Alchemy](https://kps.pqky.dev/docs/guides/cloudflare-alchemy).",
  );
