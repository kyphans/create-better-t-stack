---
title: Quick Start
description: Create your first KPS project in minutes
---
...
```npm
npm create kps@latest my-webapp \
...
```npm
npm create kps@latest my-native \
...
```npm
npm create kps@latest my-workspace \
  --frontend none \
  --backend none
```
...
<Cards>
  ...
  <Card href="/docs/kps-config" title="kps.jsonc">
