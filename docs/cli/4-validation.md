...
Dành cho các chuyên gia muốn thử nghiệm các tổ hợp chưa được hỗ trợ chính thức, CLI cung cấp flag `--yolo`. Khi bật flag này, hầu hết các kiểm tra tương thích sẽ bị bỏ qua. *Cảnh báo: Project được tạo ra có thể sẽ không build được.*
 stone.
 stone.
